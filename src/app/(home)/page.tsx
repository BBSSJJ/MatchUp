...
export const API_FOR_CHAMPION = "https://kr.api.riotgames.com/lol/platform/v3/champion-rotations";
...
export default async function HomePage() {
  ...
  return (
    <div>
      <p className={styles.title}>this week's free-to-play champions</p>
